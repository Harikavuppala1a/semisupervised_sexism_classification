...
def hier_fuse(sent_cnt, word_cnt_sent, rnn_dim, att_dim, word_feats, sen_enc_feats, dropO1, dropO2, nonlin, out_vec_size, rnn_type, stack_rnn_flag, num_cnn_filters, max_pool_k_val, kernel_sizes,st_variant):
    p1_dict = {}
    p2_dict = {}
    model_inputs = []
    att_outputs = []
    ...
    return apply_dense(model_inputs, dropO2, post_vec, nonlin, out_vec_size), att_mod, post_mod
...
def get_model(m_type, word_cnt_post, sent_cnt, word_cnt_sent, word_feats, sen_enc_feats, learn_rate, dropO1, dropO2, num_cnn_filters, rnn_type, loss_func, nonlin, out_vec_size, rnn_dim, att_dim, max_pool_k_val, stack_rnn_flag, kernel_sizes,st_variant):
    post_vec = None
    if m_type == 'flat_fuse':
        ...
        model, att_mod, post_vec = hier_fuse(sent_cnt, word_cnt_sent, rnn_dim, att_dim, word_feats, sen_enc_feats, dropO1, dropO2, nonlin, out_vec_size, rnn_type, stack_rnn_flag, num_cnn_filters, max_pool_k_val, kernel_sizes,st_variant)
