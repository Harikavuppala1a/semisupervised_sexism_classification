                                                ...
                                                for att_dim in conf_dict["att_dims"]:
                                                    for stack_rnn_flag in conf_dict["stack_rnn_flags"]:
                                                        ...
                                                        for thresh in conf_dict["threshes"]:
                                                            ...
                                                            fname_part = ("%s~%s~%s~%s~%s~%s~%s~%s~%s~%s~%s~%s~%s~%s~%s~%s~%s" % (model_type,word_feat_str,sent_enc_feat_str,prob_trans_type,class_imb_flag,num_cnn_filters,cnn_kernel_set_str,rnn_type,rnn_dim,att_dim,max_pool_k_val,stack_rnn_flag, conf_dict_com["test_mode"],conf_dict_com['st_variant'],conf_dict_com['confidence_thr'], conf_dict_com['retaining_ratio'],iter))
                                                            ...
                                                            if iter != conf_dict_com["num_iter"] - 1 :                                                                                                                                    
                                                                ...
                                                                data_dict_filename = ("%s%s%f%f%s_%d.pickle" % (conf_dict_com["save_folder_name"],conf_dict_com['st_variant'],conf_dict_com['confidence_thr'], conf_dict_com['retaining_ratio'], 'raw_data',iter+1))
                                                                index_filename = ("%s%s%f%f%s_%d.txt" % (conf_dict_com["save_folder_name"], conf_dict_com['st_variant'],conf_dict_com['confidence_thr'], conf_dict_com['retaining_ratio']'index',iter+1))
