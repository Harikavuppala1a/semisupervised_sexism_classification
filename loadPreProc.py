...
FOR_LMAP = {
  ...
  12: 'Moral policing (excluding tone policing)',
  ...
  21: 'Physical violence (excluding sexual violence)',
...
LABEL_MAP = {
  ...
  'Denial or trivialisation': 7, 
  
  'Threats': 8, 
  
  'Sexual assault (excluding rape)': 9,

  'Rape': 10,
  
  'Sexual harassment (excluding assault)': 11,
  
  'Moral policing (excluding tone policing)': 12,
  ...
  'Physical violence (excluding sexual violence)': 21,
